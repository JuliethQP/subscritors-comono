import React, { Fragment, useState, useEffect } from 'react'; /*import the hook useState from React--> to maintain a local state in a functional component */
...
export default function Fetch  ()  {
    ...
    const Sort = (subscritors, arg) => {      
        setsort(subscritors.sort((first, second) => (first[arg] > second[arg]) ? 1 : -1))     
        setsort([])
    }
